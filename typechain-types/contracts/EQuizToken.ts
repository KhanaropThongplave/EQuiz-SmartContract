...
export interface EQuizTokenInterface extends utils.Interface {
  functions: {
...
export interface EQuizToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EQuizTokenInterface;
  ...
  filters: {
    ...
    "TransferToken(address,address,uint256)"(
      ...
      claimerAddress?: PromiseOrValue<string> | null,
